...
function createPageContext() {
  return {
    ...
    //This is needed in order to inject the cirtical CSS.
...
function getPageContext() {
  // Make sure to create a new context for every server-side requrest so that data
